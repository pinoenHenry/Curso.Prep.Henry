...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  var espejo = str.split(' ').map(word => word.split('').reverse().join(''));
  return espejo.join(' ');
} 
...
function capicua(numero){
  ...
  //Escribe tu código aquí
  var aux = String(numero).split('').reverse().join('');
  if(numero === Number(aux)) return 'Es capicua';
